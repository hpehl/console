...
public class PatchElement implements IsElement<HTMLElement> {
    ...
    PatchElement(SafeHtml noFilesError) {
        ...
        this.root = form().css(upload)
                ...
                .add(labelElement = label()
                        ...
                        .add(a().css(clickable)
                                ...
                                .add(dragElement = span().textContent(" " + CONSTANTS.orDragItHere()).element()))
                        .element()).element();
