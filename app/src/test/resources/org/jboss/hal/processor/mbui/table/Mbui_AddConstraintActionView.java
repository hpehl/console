...
public final class Mbui_AddConstraintActionView extends AddConstraintActionView {
    ...
    public Mbui_AddConstraintActionView(MbuiContext mbuiContext) {
        super(mbuiContext);
        ...
        table = new ModelNodeTable.Builder<org.jboss.hal.dmr.NamedNode>("table", metadata0)
                .button("Foo", table -> presenter.reload(), Constraint.parse("executable(subsystem=foo:add)"))
                .columns("name")
                .build();
