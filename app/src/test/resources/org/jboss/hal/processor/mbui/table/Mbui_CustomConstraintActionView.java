...
public final class Mbui_CustomConstraintActionView extends CustomConstraintActionView {
    ...
    public Mbui_CustomConstraintActionView(MbuiContext mbuiContext) {
        ...
        table = new ModelNodeTable.Builder<org.jboss.hal.dmr.NamedNode>("table", metadata0)
                .button("Foo", table -> presenter.reload(), Constraint.parse("writable(/subsystem=foo@enabled)"))
                .columns("name")
                .build();
